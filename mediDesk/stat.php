  ...
  <div class="row">
    ...
    <div class="col-sm-6">
     <div class="search-box">
        ...
        <input id="ccod" class="form-control" type="text" autocomplete="off" placeholder="Search company code" />
        <input style="margin-left: 100%;margin-top: -11%;" class="btn btn-primary mb-2" type="submit4" name="submit">
