...
<div class="firstq">
                ...
                <p class="qq">Do you ever been ACM Class In Stamford University?</p>
               <form id="mainForm" name="mainForm" class="fst" >
                ...
                <input style="margin-top: 43%;" id="submit1" onclick="myFun20()" type="button" class="btn btn-success" value="Submit">
