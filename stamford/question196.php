...
<div class="firstq">
                ...
                <p class="qq">What is your Position of Web Design sector? </p>
               <form id="mainForm" name="mainForm" class="fst" >
                ...
                <input style="display: none;" id="stdid" type="" value="<?php echo $id ; ?>" name="">
                  ...
                  <input style="margin-top: 18%;" id="submit" onclick="myFun100()" type="button" class="btn btn-success" value="Submit">
